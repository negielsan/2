...
Bots = [ririnMID,dna1MID,dna2MID,dna3MID,dna4MID]
creator = ["ueca4120a9d7b0e4a9e7f4f1b1b96a436"]
Owner = ["ueca4120a9d7b0e4a9e7f4f1b1b96a436"]
admin = ["ueca4120a9d7b0e4a9e7f4f1b1b96a436","u40d66b1f1c5ce30fdce9507a73247ef1","uc2d366327a79c98701b0b8bd9e08c0c9","ubcce0f23f428d75703fb33ee06c083b6"]
...
#=======================================================================================
                elif msg.text.lower().startswith("dna1ll "):
                    if msg._from in Owner:
                       targets = []
                       key = eval(msg.contentMetadata["MENTION"])
                       key["MENTIONEES"][0]["M"]
