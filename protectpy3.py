...
#Khusus Login Token
ririn = LINE('EsZlHRKlp9ctfJOCnnH7.hOCA6T54lk3cw5YLsZJq9W.cqqJyHQby6dylwY+0lAmASiHGFyb4rBIF4RN40cmdfA=')
ririn.log("Auth Token : " + str(ririn.authToken))
ririn.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

dna1 = LINE('EsD1PY9exUZqSPBTqo8b.cY6+YCBCDcB6/j3HdvZCAW.HKrmn1VW0JDZMmq2DYqCHb0cNn7P+b6kpEvIz/37lm4=')
dna1.log("Auth Token : " + str(ririn.authToken))
dna1.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

dna2 = LINE('EsQNDJqJ2Z2Xsb9otTt1.Sl2u8yHwWYZHMslzI9Bi8q.JpxURof6vLQX4Q+HliCwMDLvgQ7gObN/IxlMgs9Y1Sc=')
dna2.log("Auth Token : " + str(ririn.authToken))
dna2.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

dna3 = LINE('Es9LfPYyKaMq82Qk1Lt8.M53qiD/PJ1i6qsVfYwB7Ea.F8gOHdx1J5amR384ybLamyE9Xc5Hukg572eDAYwj8uo=')
dna3.log("Auth Token : " + str(ririn.authToken))
dna3.log("Timeline Token : " + str(ririn.tl.channelAccessToken))
