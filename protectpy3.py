...
#Khusus Login Token
ririn = LINE('EsvvsxWTmdTJxOBYDZ03.AyYjmj1wx1XO996D9ONsaW./ukNxDEwQkk8ZlhmAc1ptMCz9ZgUfdm93ROOO49d2b8=')
ririn.log("Auth Token : " + str(ririn.authToken))
ririn.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

ki = LINE('EsWVajXt0VbV9B77WnAd.l2coFJtn227whdvygI2TFq.OebUqhnofOMpkIfblXDQ3V2jV7TmxEdqTTmmzhyEiVA=')
ki.log("Auth Token : " + str(ririn.authToken))
ki.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

kk = LINE('EsGLhld54oLO3oVpUz32.qo8kz2X1oHNmM76nRXf7eG.lOqt8GVKpjtHtHXSAUhXvEBgqWITEcIm/dUcFzErmoo=')
kk.log("Auth Token : " + str(ririn.authToken))
kk.log("Timeline Token : " + str(ririn.tl.channelAccessToken))

kc = LINE('EseqUigHksPzvaug97Y5.4P9l9oT1uVPCykUvXQ2Zrq.89RTG7N4x0woR716gabDztwMlYauPpvVBwRKSAgC4GU=')
...
owner=["ue0edee01d554184c78f2a5d68af285c8"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def restart_program():
    ...
    os.exeririn(python, python, * sys.argv)
...
#============================================================#
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if wait["timeline"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        msg.text = "URLâ†’\n" + msg.contentMetadata["postEndUrl"]
                    ririn.sendMessage(msg.to,msg.text)
            elif msg.text is None:
                return
            elif msg.text in ["Keyword","help","Help"]:
               if msg._from in admin:
                if wait["lang"] == "JP":
                    ririn.sendMessage(msg.to,helpMessage)
                else:
                    ririn.sendMessage(msg.to,helpt)
            elif ("Gn " in msg.text):
               if msg._from in admin:
                if msg.toType == 2:
                    ...
                    ririn.sendMessage(msg.to,"It can't be used besides the group.")
               ...
               if msg._from in admin:
                  ...
                  for target in targets:
                    try:
                      ...
                      ririn.sendMessage(msg.to,"Semoga Tenang Di Luar Sana")
                      pass
               ...
               if msg._from in admin:
                  ki.sendMessage(msg.to,"「Group」\n\nWaiting for : Group List")
                  gid = ririn.getGroupIdsJoined()
                  h = ""
                  for i in gid:
                      h += "║○%s\n" % (ririn.getGroup(i).name+"\n║Members: "+str(len(ririn.getGroup(i).members)))
                  ririn.sendMessage(msg.to,"╔═════¤|{ List Grup }|¤═════\n" + h + "╠═══════[  Total  ]════════\n║" + str(len(gid)) + "\n╚════════════════════")
            elif msg.text in ["Restart"]:
               if msg._from in admin:
                  ririn.sendMessage(msg.to, "Bot Have Been Restart")
                  restart_program()
                  print ("Restart")
            elif msg.text in ["全キャンセル"]:
               if msg._from in admin:
                if msg.toType == 2:
                    X = ririn.getGroup(msg.to)
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            ririn.sendMessage(msg.to,"招待は0件です。")
                        else:
                            ririn.sendMessage(msg.to,"招待は0件です。")
                else:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Can not be used outside the group")
                    else:
                        ririn.sendMessage(msg.to,"Not for use less than group")
            #elif "gurl" == msg.text:
               ...
               if msg._from in admin:
               	if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"already open")
                else:
                    if wait["lang"] == "JP":
              ...
              if msg._from in admin:
                if msg.toType == 2:
                    ...
                    ririn.updateGroup(X)
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Kode QR Sudah Di Tutup")
                    else:
                        ririn.sendMessage(msg.to,"Sudah Tertutup")
                else:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Can not be used outside the group")
                    else:
                  ...
                  ririn.sendMessage(msg.to,"Perintah Ditolak.")
                  ririn.sendMessage(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
               ...
               if msg._from in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                            ...
                            u = "open"
                        ririn.sendMessage(msg.to,"[group name]\n" + str(ginfo.name) + "\n[gid]\n" + msg.to + "\n[group creator]\n" + gCreator + "\n[profile status]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\nmembers:" + str(len(ginfo.members)) + "members\npending:" + sinvitee + "people\nURL:" + u + "")
                    else:
                        ririn.sendMessage(msg.to,"[group name]\n" + str(ginfo.name) + "\n[gid]\n" + msg.to + "\n[group creator]\n" + gCreator + "\n[profile status]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                    if wait["lang"] == "JP":
                ...
                ririn.sendMessage(msg.to,"line://home/post?userMid="+mid+"&postId="+ririn.new_post(tl_text)["result"]["post"]["postInfo"]["postId"])
            elif "Cn " in msg.text:
               if msg._from in admin:
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    ririn.sendMessage(msg.to,"Update Names " + string)
               ...
               if msg._from in admin:
                if wait["Protectcancel"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"オンにしました。")
                    else:
                        ririn.sendMessage(msg.to,"オンにしました。")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"オンにしました。")
            elif msg.text in ["キャンセル保護:オフ","pc off"]:
               if msg._from in admin:
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Protect Cancel Off")
                    else:
               ...
               if msg._from in admin:
                if wait["Protectguest"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Guest Stranger On")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
               ...
               if msg._from in admin:
                if wait["Protectguest"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Guest Stranger Off")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
               ...
               if msg._from in admin:
                if wait["CloseQR"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Closed QR On")
                    else:
                        ririn.sendText(msg.to,"done")
                else:
                    wait["CloseQR"] = True
               ...
               if msg._from in admin:
                if wait["CloseQR"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Closed QR Off")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
                    wait["CloseQR"] = False
               ...
               if msg._from in admin:
                if wait["acck"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Udah aktif kak")
                    else:
                        ririn.sendMessage(msg.to,"Done")
                else:
                    wait["acck"] = True
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Anti Join Mode on")
                    else:
                        ririn.sendMessage(msg.to,"Done")
               ...
               if msg._from in admin:
                if wait["acck"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Sudah off kak")
                    else:
                        ririn.sendMessage(msg.to,"Done")
                else:
                    wait["acck"] = False
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Anti Join Mode off")
                    else:
                        ririn.sendMessage(msg.to,"Done")
            elif msg.text in ["URL保護:オン","qr on"]:
               if msg._from in admin:
                if wait["ProtectQR"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Protect QR On")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
                    wait["ProtectQR"] = True
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"done")
            elif msg.text in ["URL保護:オフ","qr off"]:
               if msg._from in admin:
                if wait["ProtectQR"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Protect QR Off")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
               ...
               if msg._from in admin:
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"already on")
                    else:
                        ririn.sendMessage(msg.to,"done")
                else:
                    wait["contact"] = True
               ...
               if msg._from in admin:
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"already off")
                    else:
                        ririn.sendMessage(msg.to,"done ")
                else:
                    wait["contact"] = False
               ...
               if msg._from in admin:
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            ririn.sendMessage(msg.to,"Invitation refused turned off\nTo turn on please specify the number of people and send")
                        else:
                            ririn.sendMessage(msg.to,"å…³äº†é‚€è¯·æ‹’ç»ã€‚è¦æ—¶å¼€è¯·æŒ‡å®šäººæ•°å‘é€")
                    else:
                        num =  int(strnum)
                        wait["autoCancel"]["on"] = True
                        if wait["lang"] == "JP":
                            ririn.sendMessage(msg.to,strnum + "The group of people and below decided to automatically refuse invitation")
                        else:
                            ririn.sendMessage(msg.to,strnum + "ä½¿äººä»¥ä¸‹çš„å°ç»„ç”¨è‡ªåŠ¨é‚€è¯·æ‹’ç»")
                except:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Value is wrong")
                    else:
                        ririn.sendMessage(msg.to,"Bizarre ratings")
               ...
               if msg._from in admin:
                if wait["leaveRoom"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"è¦äº†å¼€ã€‚")
               ...
               if msg._from in admin:
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"already")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ³","共有:オン","Share on"]:
               if msg._from in admin:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"already on")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"è¦äº†å¼€ã€‚")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ•","共有:オフ","Share off"]:
               if msg._from in admin:
                if wait["timeline"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"è¦äº†å…³æ–­ã€‚")
               ...
               if msg._from in admin:
                ...
                if wait["lang"] == "JP":
                    ririn.sendMessage(msg.to,"All invitations have been refused")
                else:
                    ririn.sendMessage(msg.to,"Semua grup sudah dibatalkan")
               ...
               if msg._from in admin:
                if wait["autoAdd"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ririn.sendMessage(msg.to,"è¦äº†å…³æ–­ã€‚")
            elif msg.text in ["よくわからないﾝｱﾞｱﾞｱﾞｱﾞｱﾞｱﾞｱﾞｱﾞ"]:
              if msg._from in admin:
                if msg.toType == 2:
                    X = ririn.getGroup(msg.to)
                    ...
                    ririn.updateGroup(X)
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"QR Sudah Dibuka")
                    else:
                        ririn.sendMessage(msg.to,"Sudah Terbuka")
                else:
                    if wait["lang"] == "JP":
                        ririn.sendMessage(msg.to,"Can not be used outside the group")
                    else:
...
#----------------Bot Out All Group Start------------------------------#
               ...
               if msg._from in admin:
                if msg.toType == 2:
                   ...
                   if wait["lang"] == "JP":
                     ririn.sendMessage(msg.to,"Sayonara")
                   else:
                     ririn.sendMessage(msg.to,"He deririnined all invitations")
#--------------------------Bot Out All Group Start----------------------------#
            elif msg.text in ["引退"]:
               if msg._from in admin:
                if msg.toType == 2:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    ririn.sendText(msg.to,"Succes ")
                                except:
                                    ririn.sendMessage(msg.to,"error")
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ririn.sendMessage(msg.to,"Target Tidak Djtemukan")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
...
#---------------------------------------------------------------------
            elif msg.text in ["速度","speed"]:
                start = time.time()
                ririn.sendMessage(msg.to, "Proccess...")
                elapsed_time = time.time() - start
                ririn.sendMessage(msg.to, "速度: %sec" % (elapsed_time))
#------------------------------------------------------------------
